...
export const POST = handler(
  async ({ req, user }) => {
    ...
    await emit({ type: EVENT_TYPES.IRMS_REPORT_UPDATED, resourceType: "InspectionReport", resourceId: report.id, payload: { code, action: "CREATED" }, actorType: "USER", actorId: user.id });
